...
SESSION_INACTIVITY_SECONDS = 2 * 60 * 60
...
async def fetch_train_availability(
    ...
    # print("QUOTA:", quota)
    # print("SOURCE:", source_station)
    # print("DESTINATION:", destination_station)
...
async def search_trains(
    ...
    # print("TBIS SOURCE EXACT:", repr(source_station))
    # print("TBIS DESTINATION EXACT:", repr(destination_station))
    # print("\n========== TBIS STATION DEBUG ==========")
    # print("FRONTEND FROM NAME:", request.from_name)
    # print("FRONTEND FROM CODE:", request.from_code)
    # print("TBIS SOURCE:", source_station)
    # print()
    # print("FRONTEND TO NAME:", request.to_name)
    # print("FRONTEND TO CODE:", request.to_code)
    # print("TBIS DESTINATION:", destination_station)
    # print("========================================\n")
